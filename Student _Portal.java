    ...
    if(e.getSource()==button ){
       ...
       try{
        ...
        JOptionPane.showMessageDialog(null,"Image loading error" );
         ...
         sub_panel3.setBackground(new Color(0x735DA5));
         sub_panel3.setLayout(new BorderLayout());


        JPanel sub_panel3_1=new JPanel();
        sub_panel3_1.setPreferredSize(new Dimension(500,40));
        sub_panel3_1.setBackground(new Color(0x00246B));

        JLabel sub_label3_1=new JLabel();
        sub_label3_1.setText("Indira Gandhi University");
        sub_label3_1.setFont(new Font(Font.SERIF,  Font.BOLD, 20));
        sub_label3_1.setForeground(Color.orange);


        JPanel sub_panel3_2=new JPanel();
        sub_panel3_2.setPreferredSize(new Dimension(500,540));
        sub_panel3_2.setBackground(new Color(0x735DA5));



         sub_panel3.add(sub_panel3_1,BorderLayout.NORTH);
         sub_panel3_1.add(sub_label3_1,BorderLayout.CENTER);
         sub_panel3.add(sub_panel3_2,BorderLayout.SOUTH);
